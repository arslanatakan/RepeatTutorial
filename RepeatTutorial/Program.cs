...
namespace RepeatTutorial
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Vadesiz Hesap Numaranızı Giriniz:");
            ...
            Console.Write("Tasarruf hesabına para çekmek için miktar girin:");
            ...
            Console.Write("Vadesiz hesabına para çekmek için miktar girin:");
